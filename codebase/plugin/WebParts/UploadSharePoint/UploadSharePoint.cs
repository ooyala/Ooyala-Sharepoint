...
namespace OoyalaPlugin.Controls.UploadSharePoint
{
    ...
    public class UploadSharePoint : WebPart
    {
        ...
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/OoyalaPlugin.Controls/UploadSharePoint/UploadSharePointUserControl.ascx";
        ...
        protected override void CreateChildControls()
        {
            ...
            if (result == 1)
            {
                UploadSharePointUserControl control = (UploadSharePointUserControl)Page.LoadControl(_ascxPath);
